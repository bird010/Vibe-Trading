...
- manifest SHA-256：`8a51dc1d2d2c8a129ec54baa1d5c474519b5b06de6fa59dafef7e7226092873b`
...
104 周 Shadow requirement 仍为 `UNRESOLVED`；Shadow 是持续 append-only 过程，不能标记为完成资格。
