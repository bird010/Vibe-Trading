...
import { Activity, BarChart3, Bot, FileText, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, Network } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/stockpred", icon: Network, label: t('layout.stockPred') },
