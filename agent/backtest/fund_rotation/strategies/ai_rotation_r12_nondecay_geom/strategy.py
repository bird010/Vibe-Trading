"""Round 12 challenger: rank clusters by persistent geometric momentum.
...
DESCRIPTOR = FundRotationStrategyDescriptor(
    id="ai_rotation_r12_nondecay_geom",
    name="持续几何动量相关性代表ETF",
    description=(
        "复用相关性聚类代表ETF流程，要求当前及向后错一周的四周簇动量"
        "均严格为正且当前动量不低于滞后动量，并按两者增长因子的"
        "等权几何均值排名。"
    ),
...
_SCORE_MODEL_ID = "nondecay_persistent_geometric_cluster_momentum"
_SCORE_MODEL_LABEL = "Non-decaying Persistent Geometric Cluster Momentum"
...
def nondecay_geometric_score(
    ...
    return StrategyScore(
        ...
        components={
            ...
            "nondecay_geometric_momentum": geometric,
            "nondecay_delta": nondecay_delta,
        },
    )


def compute_nondecay_geom_scores(
    ...
    scores = {
        cluster_id: nondecay_geometric_score(
    ...
    return scores, current_values, lagged_values, delta_values, geometric_values


class AiRotationR12NondecayGeomSession(CorrelationRepresentativeSession):
    """Isolated session with round 12 persistent-geometry ranking."""
    ...
    def evaluate(self, context: StrategyDecisionContext) -> TargetWeightDecision:
        ...
        scores, current_raw, lagged_raw, delta_raw, geometric_raw = compute_nondecay_geom_scores(
            momentum_window,
            self._clusters,
        ...
        decision = TargetWeightDecision(
            ...
            diagnostics={
                ...
                "nondecay_delta": delta_values,
                "nondecay_delta_unavailable_clusters": delta_unavailable,
                ...
                "persistence_gate": "current_and_lagged_strictly_positive_and_nondecaying",
                "score_model": {
                    "id": _SCORE_MODEL_ID,
...
class AiRotationR12NondecayGeomStrategy:
    """Complete round 12 strategy plug-in."""
    ...
    def describe_decision_pipeline(self, config: BaseModel) -> dict[str, object]:
        ...
        pipeline["selection_rule"] = (
            ...
            "one-week-lagged momentum, requiring non-decay and ranked by "
            "their geometric growth mean"
        )
        return pipeline
    ...
    def create_session(
        ...
        config: BaseModel,
    ) -> AiRotationR12NondecayGeomSession:
        return AiRotationR12NondecayGeomSession(config)  # type: ignore[arg-type]
